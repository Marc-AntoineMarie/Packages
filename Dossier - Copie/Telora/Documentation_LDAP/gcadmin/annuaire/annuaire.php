            ...
            <div class="annuaire-container">
                <div class="title-section">
                    ...
                    <div class="actions">
                        ...
                        <button class="btn btn-primary" onclick="document.getElementById('addContactModal').style.display='block'">
                        ...
                        <div class="contact-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-actions">
                                    <button class="btn-icon" onclick="openEditContactModal(<?php echo $contact['iduser_annuaire']; ?>, <?php echo $clientsId; ?>)">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button class="btn-icon btn-delete" onclick="if(confirm('Êtes-vous sûr de vouloir supprimer ce contact ?')) window.location.href='?action=delete&id=<?php echo $contact['iduser_annuaire']; ?>&idclients=<?php echo $clientsId; ?>'">
                ...
                <div class="annuaire-per-page" style="margin-top: 14px;">
                    ...
                    <select id="perPage" onchange="window.location.href='?idclients=<?php echo $clientsId; ?>&page=1&perPage='+this.value;">
                        <option value="10" <?php if($perPage==10) echo 'selected'; ?>>10</option>
                        <option value="25" <?php if($perPage==25) echo 'selected'; ?>>25</option>
                        <option value="50" <?php if($perPage==50) echo 'selected'; ?>>50</option>
                        <option value="100" <?php if($perPage==100) echo 'selected'; ?>>100</option>
                        <option value="1000" <?php if($perPage==1000) echo 'selected'; ?>>1000</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <form id="addContactForm" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline" onclick="document.getElementById('addContactModal').style.display='none'">Annuler</button>
