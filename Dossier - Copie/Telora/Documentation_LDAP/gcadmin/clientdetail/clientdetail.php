        ...
        <div class="clientdetail-container">
            ...
            <div class="header-actions">
                ...
                <div class="action-group">
                    <a href="../annuaire/annuaire.php?idclients=<?php echo $idclient; ?>" class="btn-action btn-secondary">
                        Gérer l'annuaire
                    </a>
                    <button class="btn-action btn-primary" onclick="document.getElementById('addUserModal').style.display='block'">Nouveau</button>
                </div>
            </div>
            ...
            <div style="padding: 0 20px;">
                        ...
                        <tr>
                            <td>
                                <div class="user-info">
                                    ...
                                    <div class="user-details">
                                        ...
                                        <div class="user-extension"><?php echo htmlspecialchars($utilisateur['Extension']); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="user-details">
                                    <div class="user-name"><?php echo htmlspecialchars($utilisateur['TypePoste']); ?></div>
                                    <div class="user-extension"><?php echo htmlspecialchars($utilisateur['SIPServeur']); ?></div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="">
                                <div class="action-buttons">
                                    <form method="POST" action="../utilisateurdetail/utilisateurdetail.php" style="display:inline;">
                                        <input type="hidden" name="idutilisateur" value="<?php echo htmlspecialchars($utilisateur['idutilisateurs']); ?>">
                ...
                <div class="pagination">
                    <div class="pagination-info">
                        <div class="items-per-page">
                            <select onchange="changePerPage(this.value)">
                                ...
                                <option value="all" <?php echo $perPage === PHP_INT_MAX ? 'selected' : ''; ?>>Tous</option>
                            </select>
                        </div>
                        <div class="showing-entries">
                            ...
                            <?php else: ?>
                                Affichage <?php echo $totalUsers > 0 ? ($offset + 1) : 0; ?> à <?php echo min($offset + $perPage, $totalUsers); ?> sur <?php echo $totalUsers; ?> utilisateurs
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php if ($perPage !== PHP_INT_MAX): ?>
                    <div class="pagination-controls">
                        <?php if ($page > 1): ?>
                            <a href="?idclient=<?php echo $idclient; ?>&page=1&perPage=<?php echo $perPage; ?>" class="pagination-button">«</a>
                            <a href="?idclient=<?php echo $idclient; ?>&page=<?php echo ($page - 1); ?>&perPage=<?php echo $perPage; ?>" class="pagination-button">‹</a>
                        <?php endif; ?>
                        ...
                        <?php if ($page < $totalPages): ?>
                            <a href="?idclient=<?php echo $idclient; ?>&page=<?php echo ($page + 1); ?>&perPage=<?php echo $perPage; ?>" class="pagination-button">›</a>
                            <a href="?idclient=<?php echo $idclient; ?>&page=<?php echo $totalPages; ?>&perPage=<?php echo $perPage; ?>" class="pagination-button">»</a>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="clientdetail.php">
                ...
                <div class="form-actions">
                    ...
                    <button type="button" class="btn-action btn-secondary" onclick="document.getElementById('addUserModal').style.display='none'">Annuler</button>
                </div>
            </form>
        </div>
    </div>
